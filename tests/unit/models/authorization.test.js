...
describe("models/authorization", () => {
  describe(".can()", () => {
    ...
    test("with valid `user` and known `feature`", async () => {
      const createdUser = {
  ...
  describe(".filterOutput()", () => {
    ...
    test("with valid `user`, known `feature` and `resource`", async () => {
      const createdUser = {
        features: ["read:user"],
      };
    ...
    test("with valid `user`, known `feature` but no `resource`", async () => {
      const createdUser = {
        features: ["read:user"],
      };
